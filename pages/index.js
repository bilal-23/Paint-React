...
export default function Home() {
  ...
  useEffect(() => {
    ...
    timeline.from(sectionRef.current, { opacity: 0 }).from(backgroundRef.current, { duration: 1, scale: 0.5, zIndex: 1, duration: 1 })
      .from(navbarRef.current, { opacity: 0 })
      .fromTo(headingRef.current, { y: "100px", opacity: 0, duration: '1', delay: 1 }, { y: '-10px', opacity: 1 })
